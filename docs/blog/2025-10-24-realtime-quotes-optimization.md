...
docker build --platform linux/amd64 -t XinPan-ITS:amd64 .
docker tag XinPan-ITS:amd64 your-registry/XinPan-ITS:amd64
docker push your-registry/XinPan-ITS:amd64

# ARM64 架构（Apple Silicon/ARM服务器）
docker build --platform linux/arm64 -t XinPan-ITS:arm64 .
docker tag XinPan-ITS:arm64 your-registry/XinPan-ITS:arm64
docker push your-registry/XinPan-ITS:arm64
```
...
```bash
# AMD64 用户
docker pull your-registry/XinPan-ITS:amd64

# ARM64 用户
docker pull your-registry/XinPan-ITS:arm64
```
