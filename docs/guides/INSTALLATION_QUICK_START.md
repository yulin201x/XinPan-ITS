...
> 5分钟快速上手 XinPan-ITS v1.0.0-preview
...
- 关注公众号 "XinPan-ITS" 获取网盘链接

操作手册：

https://mp.weixin.qq.com/s/uAk4RevdJHMuMvlqpdGUEw
XinPan-ITS v1.0.0-preview绿色版（目前只支持windows）简单使用手册
https://mp.weixin.qq.com/s/o5QdNuh2-iKkIHzJXCj7vQ
XinPan-ITS v1.0.0-preview绿色版绿色版端口配置说明
---
...
# 2. 创建项目目录
mkdir XinPan-ITS && cd XinPan-ITS
...
- **GitHub Issues**: [提交问题](https://github.com/hsliuping/XinPan-ITS/issues)
- **微信公众号**: XinPan-ITS
- **QQ 群**: 关注公众号获取群号
