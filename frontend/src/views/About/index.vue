      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <div class="hero-acknowledgment">
            ...
            <span>基于 <a href="" target="_blank" rel="noopener noreferrer">TradingAgents</a> 项目开发，感谢原项目的贡献</span>
          </div>
      ...
      <div class="origin-content">
        <div class="origin-card">
          ...
          <div class="origin-description">
            <p>
              <strong>XinPan-ITS</strong> 是基于 <strong>TradingAgents</strong> 项目开发的中文本地化版本。
